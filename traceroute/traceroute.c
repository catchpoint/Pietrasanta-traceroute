...
static CLIF_option option_list[] = {
    ...
    { "t", "tos", "num", "Set the TOS (IPv4 type of service) or TC (IPv6 traffic class) value for outgoing packets. This option excludes --dscp and --ecn. Allowed values are between 0 and 255", CLIF_set_uint, &tos_input_value, 0, 0 },
    ...
    { 0, "dscp", "num", "Set the DSCP bits into the IP header. This option excludes -t (--tos) and might be used in conjunction with --ecn. Allowed values are between 0 and 63", CLIF_set_uint, &dscp_input_value, 0, 0 },
    { 0, "ecn", "num", "Set the ECN bits into the IP header. This option excludes -t (--tos) and might be used in conjunction with --dscp. Allowed values are between 0 and 3", CLIF_set_uint, &ecn_input_value, 0, 0 },
