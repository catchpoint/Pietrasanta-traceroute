...
extern int flags_provided; // This is used to remember if the user supplied a TCP flags value. This is needed because the user could supply a value of zero
